 ...
 */
final class Version20240111132619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE directory (id UUID NOT NULL, space_id UUID NOT NULL, directory_id UUID DEFAULT NULL, created_by_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN invitation.accepted_at IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN invitation.canceled_at IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN invitation.created_at IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('CREATE TABLE member (id UUID NOT NULL, user_id UUID NOT NULL, team_id UUID NOT NULL, owner BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN member.created_at IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('CREATE TABLE refresh_token (id INT NOT NULL, refresh_token VARCHAR(128) NOT NULL, username VARCHAR(255) NOT NULL, valid TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C74F2195C74F2195 ON refresh_token (refresh_token)');
        $this->addSql('CREATE TABLE space (id UUID NOT NULL, team_id UUID NOT NULL, created_by_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN space.created_at IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('CREATE TABLE task (id UUID NOT NULL, view_id UUID NOT NULL, created_by_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN task.created_at IS \'(DC2Type:carbondatetime_immutable)\'');
        ...
        $this->addSql('COMMENT ON COLUMN team.created_at IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('CREATE TABLE time_entry (id UUID NOT NULL, task_id UUID NOT NULL, created_by_id UUID DEFAULT NULL, start_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN time_entry.start_date IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN time_entry.end_date IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN time_entry.created_at IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('CREATE TABLE "user" (id UUID NOT NULL, email VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, confirmed BOOLEAN NOT NULL, roles TEXT NOT NULL, password VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN "user".id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN "user".roles IS \'(DC2Type:simple_array)\'');
        $this->addSql('COMMENT ON COLUMN "user".created_at IS \'(DC2Type:carbondatetime_immutable)\'');
        $this->addSql('CREATE TABLE view (id UUID NOT NULL, directory_id UUID NOT NULL, created_by_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN view.created_at IS \'(DC2Type:carbondatetime_immutable)\'');
